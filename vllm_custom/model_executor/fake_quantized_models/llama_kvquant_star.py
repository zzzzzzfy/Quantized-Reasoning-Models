...
class LlamaModel(nn.Module):
    ...
    def load_weights(self, weights: Iterable[Tuple[str,
        ...
        partitioned_k_dim = (self.config.hidden_size // self.config.num_attention_heads * self.config.num_key_value_heads) // world_size
        for i in range(self.start_layer, self.end_layer):
...
class LlamaKVQuantStarForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
